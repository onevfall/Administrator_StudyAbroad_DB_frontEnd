          ...
          <el-tabs v-model="activeName" class="tabs" @tab-click="handleClick">
            <el-tab-pane label="未审核" name="first">
              <div class="check-content">
                <el-row>
                  <el-col :span="6" style="text-align:left;padding-left:8%">回答评论</el-col>
                  <el-col :span="8" >举报理由</el-col>
                  <el-col :span="6" >举报用户</el-col>
                  <el-col :span="4" >操作</el-col>
                </el-row>
              </div>
              <div class="check-content" v-for="ans in this.answercomment_tocheck_info" :key="ans">
                <el-row>
                  <el-col :span="6" style="text-align:left">
                    <div style="font-size:20px;color:black">{{ ans.AnswerCommentContent }}</div>
                  ...
                  <el-col :span="4" style="color:#2297FA;padding-top:2%" >
                    <el-button type="primary" @click="goReportCheck(ans.ReportId,ans.AnswerCommentId)" id="check-text" style="width:100px">
            ...
            <el-tab-pane label="已审核" name="second">
              ...
              <div class="check-content" v-for="ans in this.answercomment_checked_info" :key="ans">
                <el-row>
                  <el-col :span="6" style="text-align:left">
                    <div style="font-size:20px;color:black">{{ ans.AnswerCommentContent }}</div>
                    <div style="margin-top:10px">{{ ans.ReportDate }}</div>
...
export default ({
  name: "AnswerCommentReportCenter",
  data() {
    return {
  ...
  methods:{
    goReportCheck:function(rep_id,anscom_id){
      this.$router.push({
        name:"answer_comment_report",
        query: { 
            report_id: rep_id,
            answercomment_id:anscom_id,
         }
      });
    }
  },
