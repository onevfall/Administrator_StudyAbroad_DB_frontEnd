        ...
        <div class="card-content">
          <el-row style="margin-top: 20px">
            ...
            <el-col :span="4" style="text-align: left">{{
              blogcomment_info.AnswerCommentId
            }}</el-col>
          </el-row>
            ...
            <el-col :span="10" style="text-align: left">
              <div style="display: inline-block; vertical-align: middle">
                <el-avatar
                  shape="circle"
                  :size="50"
                  :src="blogcomment_info.ReportedUserProfile"
                />
              </div>
              <div
                style="display: inline-block; padding-left: 5px; color: black"
              >
          ...
          <el-row style="margin-top: 50px">
            ...
            <el-col :span="10" style="text-align: left">{{
              blogcomment_info.AnswerCommentContent
            }}</el-col>
          </el-row>
          ...
          <el-row style="margin-top: 50px">
            ...
            <el-col :span="10" style="text-align: left">{{
              blogcomment_info.AnswerCommentDate
            }}</el-col>
          </el-row>
          ...
          <el-row style="margin-top: 50px">
            ...
            <el-col :span="10" style="text-align: left"
              ><p v-html="blogcomment_info.RepliedBlogContent"></p
            ></el-col>
          </el-row>
            ...
            <el-col :span="10" style="text-align: left">
              <div style="display: inline-block; vertical-align: middle">
                <el-avatar
                  shape="circle"
                  :size="50"
                  :src="blogcomment_info.UserProfile"
                />
              </div>
              <div
                style="display: inline-block; padding-left: 5px; color: black"
          ...
          <el-row style="margin-top: 50px">
            ...
            <el-col :span="10" style="text-align: left">{{
              blogcomment_info.ReportedDate
            }}</el-col>
          </el-row>

          <el-row style="margin-top: 50px">
            <el-col :span="3"></el-col>
            <el-col :span="4" style="text-align: left; margin-top: 7px"
              >是否审核通过：</el-col
            >
            <el-col :span="8" style="text-align: left">
              <el-radio v-model="this.ReviewResult" :label=true size="large"
                ><span style="font-size: 20px; font-weight: 900"
                  >是</span
                ></el-radio
              >
              <el-radio v-model="this.ReviewResult" :label=false size="large"
                ><span style="font-size: 20px; font-weight: 900"
                  >否</span
                ></el-radio
              >
          ...
          <div v-show="this.ReviewResult">
            <el-row style="margin-top: 50px">
              ...
              >
              <el-col :span="8" style="text-align: left">
                <el-radio v-model="BanResult" :label=true size="large"
                  ><span style="font-size: 20px; font-weight: 900"
                    >是</span
                  ></el-radio
                >
                <el-radio v-model="BanResult" :label=false size="large"
                  ><span style="font-size: 20px; font-weight: 900"
                    >否</span
                  ></el-radio
                >
          ...
          <!-- <el-row style="margin-top: 0px" v-show="!this.ReviewResult"> </el-row> -->
        ...
        axios
          ...
          .then((res) => {
            ...
            if (response.status == true) {
              ...
              ElMessage({
                message:
                  "ID为" + this.blogcomment_id + "的动态评论举报审核成功！",
                type: "success",
                showClose: true,
                duration: 2000,
              });
  ...
  created(){
    ...
    axios({
      ...
      .then((res) => {
        ...
        this.blogcomment_info.ReportedDate =
          this.blogcomment_info.ReportedDate.replace("T", " ");
        this.blogcomment_info.AnswerCommentDate =
          this.blogcomment_info.AnswerCommentDate.replace("T", " ");
        if (this.blogcomment_info.RepliedBlogContent == null) {
          this.blogcomment_info.RepliedBlogContent =
            this.blogcomment_info.RepliedComment;
          this.blogcomment_info.RepliedBlogDate =
            this.blogcomment_info.RepliedCommentDate;
        }
